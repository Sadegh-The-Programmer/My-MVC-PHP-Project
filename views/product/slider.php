...
<div class="Scroll-Slider col-xs-12">
    <h3 style="margin-right: 30px;">محصولات مشابه</h3>
    <div class="slider-content col-xs-12">
        ...
        <div class="col-xs-12 col-sm-11 main">
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="<?=URL.'product/index/'.$like['id'];?>">
                        <img style="width: 120px;" src="public/images/products/<?=$like['id'];?>/medium/product3.jpg"/>
                        <br/>
                        <img src="public/images/sliderscroll1/exclusive-blue.png"/>
                        <p class="text-center"><?=$like['title'];?></p>
                        <p class="text-center price"> <?=$like['price'];?>
                            ریال</p>
                    </a>
                </li>
                <?php } ?>
